...
const Grade = () => {
    ...
    useEffect(()=>{
        axios.get(`https://server.imthesong.site/student/grade/${localStorage.getItem("userCode")}`)//여기에 로컬 스토리지에서 유저코드 들고와서 넣기;
            .then(({data})=>{
    ...
    const search = ()=>{
        ...
        axios.post(`https://server.imthesong.site/student/grade/search/${localStorage.getItem("userCode")}`, {
