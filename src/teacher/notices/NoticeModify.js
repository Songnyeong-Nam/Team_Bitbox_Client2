...
const NoticeModify = ({history, match}) => {
    ...
    useEffect(() => {
        axios.get(`https://server.imthesong.site/notice/getCategory`)
            .then(({data}) => {
    ...
    const onclickSubmit = e => {
        ...
        if(a || b){
            ...
            setIsMessageContents(b)
            axios
                .post(`https://server.imthesong.site/notice/update`,
    ...
    const postApis = articleNo => {
        ...
        axios.post(`https://server.imthesong.site/file/upload/${articleNo}/null`, formData, {
