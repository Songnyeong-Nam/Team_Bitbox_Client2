...
const SubjectDetail = ({history,match}) => {
  ...
  useEffect(()=>{
    ...
    const getBasicInfo = () =>{
      axios
      .get(`https://server.imthesong.site/tsubject/basicInfo?cUserCode=${localStorage.getItem("userCode")}`)
      .then(({ data }) => {
    ...
    const getLessonList = () => {
        axios
            .get(`https://server.imthesong.site/tsubject/detailList/${localStorage.getItem("userCode")}`)
            .then(({data}) => {
    ...
    const updateList = async() =>{
      axios
      .post(`https://server.imthesong.site/tsubject/updateList/${localStorage.getItem("userCode")}`,
      { updatedList : lessons},
       {
    ...
    const deleteOne = async() => {
      axios
      .get(`https://server.imthesong.site/tsubject/deleteOne/${localStorage.getItem("userCode")}?lessonId=${lessonOne.id}`)
      .then( 
        setLessonOne({
          id : lessonOne.id,
    ...
    const deleteAll = () =>{
      ...
      axios
      .post(`https://server.imthesong.site/tsubject/deleteAll/${localStorage.getItem("userCode")}`,
      {"list" : lessonIds},
      {
        authorization: 'JWT fefege..',
        Accept : 'application/json',
  ...
  const handleUpdate = async() =>{
    axios
      .post(`https://server.imthesong.site/tsubject/updateOne`,
