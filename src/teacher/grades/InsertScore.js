...
const InsertScore = () => {
    ...
    const getScore = () => {
        axios.get(`https://server.imthesong.site/teacher/grade/get/${schoolCode.concat(semesterCode, grade, homeClass, student)}`)
            .then(({data}) => {
                if(data.length !== 0){
    ...
    const onClickGrade = value => {
        ...
        setIsWarning(false)
        setIsCheck(true)
        axios.get(`https://server.imthesong.site/teacher/grade/input/homeClass/${schoolCode}/${value}`)
            .then(({data}) => {
    ...
    const onClickHomeClass = value => {
        setIsWarning(false)
        setIsCheck(true)
        axios.get(`https://server.imthesong.site/teacher/grade/input/student/${schoolCode}/${grade}/${value}`)
            .then(({data}) => {
    ...
    const onSubmit = () => {
        ...
        axios.post(`https://server.imthesong.site/teacher/grade/input`,
